    ...
    public static class AppData
    {
        ...
        public static string SpecificPath
        {
            get
            {
                ...
                return Path.Combine(appData, GoogleDrive.Util.Utilities.ApplicationName);
            }
        }
        ...
        /// <summary>
        /// Delete the specified file when auth error. 
        /// </summary>
        public static void DeleteFile(string file)
        {
            ...
            if (Directory.Exists(dir))
            {
                File.Delete(Path.Combine(SpecificPath, file));
            }
        }
    }
}
